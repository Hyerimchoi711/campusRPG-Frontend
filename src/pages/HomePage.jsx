    ...
    <div className="screen active" id="screenHome">
      ...
      <div className="hud-top">
        <div className="hud-left">
          <div className="avatar-frame" onClick={() => navigate('/avatar')}>
            <div className="avatar-img" id="avatarDisplay">🧑‍🎓</div>
            <div className="avatar-level">Lv.7</div>
          </div>
          <div className="hud-info">
            <div className="hud-name">김대학</div>
            <div className="hud-class">🌱 새싹 모험가</div>
          </div>
        </div>
        <div className="hud-right">
          <div className="hud-currency">
            <span>💎</span><span className="currency-val">240</span>
          </div>
          <div className="hud-currency">
            <span>🔥</span><span className="currency-val streak-val">3일</span>
          </div>
        </div>
      </div>
